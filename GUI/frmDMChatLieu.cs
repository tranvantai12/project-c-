...
namespace quanlybanhang
{
    public partial class frmDMChatLieu : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            tblCL = BAL.Functions.GetDataToTable(sql); //Đọc dữ liệu từ bảng
        ...
        //    BAL.Functions.RunSQL(sql); //Thực hiện câu lệnh sql
